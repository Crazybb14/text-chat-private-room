...
export const SETTING_DEFS: SettingDef[] = [
  ...
  {
    key: "dm_file_sharing_enabled",
    label: "File sharing in private chats",
    group: "Chat & messages",
    type: "toggle",
    default: true,
    description: "Let people share files (up to 500 MB) inside direct messages. Every file waits for admin approval either way.",
  },
  {
    key: "activity_chart_enabled",
    label: "Show the activity graph",
    group: "Site",
    type: "toggle",
    default: true,
    description: "Show the busiest-times graph at the bottom of the main menu.",
  },
  {
    key: "lobby_feedback_enabled",
    label: "Feedback box on the main menu",
    group: "Site",
    type: "toggle",
    default: true,
    description: "Show the suggestion box on the main menu.",
  },
  {
